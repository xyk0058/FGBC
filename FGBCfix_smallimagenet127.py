...
def main():
    ...
    if args.resume:
        ...
        logger.set_names(['Train Loss', 'Train Loss X', 'Train Loss U', 'abcloss','Test Loss', 'Test Acc.', 'perclassacc mean', 'Minority Acc.'])
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        logger.append([train_loss, train_loss_x, train_loss_u, abcloss, test_loss, test_acc, per_cls_acc.mean()*100, per_cls_acc[int(num_class/2):].mean()*100.])
...
def train(labeled_trainloader, unlabeled_trainloader, model, optimizer, ema_optimizer, criterion, epoch,ir2):
    ...
    for batch_idx in range(args.val_iteration):
        ...
        logit, _ = model.classify2(q, cal_rn_weight=True)
        logitu1, _ = model.classify2(q1, cal_rn_weight=False)
        logitu2, _ = model.classify2(q2, cal_rn_weight=False)
        logitu3, _ = model.classify2(q3, cal_rn_weight=False)
        ...
        if epoch >400:
            ...
            mixed_input, _ = model.classify2(mixed_q, cal_rn_weight=True)
